    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyTitle}>{t('customer.bookings.emptyTitle')}</Text>
          <Text style={styles.emptySubtext}>
            {t('customer.bookings.emptySubtitle', { tab: t(`customer.bookings.tabs.${activeTab}`).toLowerCase() })}
          </Text>
        </View>
      </ScrollView>
    </View>
